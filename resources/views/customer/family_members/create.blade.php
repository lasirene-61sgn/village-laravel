...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <form method="POST" action="{{ route('customer.family.members.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center">
                        <input type="radio" name="matrimony" id="matrimony_yes" value="1" {{ old('matrimony') == '1' ? 'checked' : '' }}
                            class="mr-2">
                        <label for="matrimony_yes" class="mr-4">Yes</label>
                        
                        <input type="radio" name="matrimony" id="matrimony_no" value="0" {{ old('matrimony') == '0' || old('matrimony') == null ? 'checked' : '' }}
                            class="mr-2">
            ...
            <div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="hobbies" id="hobbies" value="{{ old('hobbies') }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
