    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <form method="POST" action="{{ route('customer.reset.password') }}">
            ...
            <div class="flex items-center justify-between">
                <a href="{{ route('customer.forgot.password') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                    Back
                </a>
