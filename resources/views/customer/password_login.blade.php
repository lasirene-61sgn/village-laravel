...
<div class="container mx-auto max-w-md">
    <div class="bg-white rounded-lg shadow-md p-6">
        <h2 class="text-2xl font-bold text-center text-gray-800 mb-6">Login with Password</h2>
        ...
        <div class="mt-4 text-center">
            <a href="{{ route('customer.forgot.password') }}" class="text-blue-600 hover:text-blue-800">Forgot Password?</a>
        </div>
    </div>
</div>
@endsection