...
<div class="p-6 md:p-8">
    ...
    <div class="flex items-center space-x-3 mb-6">
        ...
        <h2 class="text-2xl font-bold text-gray-800 tracking-tight">Edit Notice: {{ $notice->name }}</h2>
    </div>
    
    {{-- Responsive styling applied: removed max-w-2xl mx-auto for wider layout --}}
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6 md:p-8">
        <form action="{{ route('admin.notice.update', $notice->id) }}" method="POST">
            ...
            {{-- Notice Name Field --}}
            <div class="mb-5">
                <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Notice Name <span class="text-red-500">*</span></label>
                <input type="text" 
            ...
            <div class="mb-5">
                <label for="description" class="block text-sm font-medium text-gray-700 mb-1">Description / Content</label>
            ...
            <div class="flex gap-3 pt-4 border-t border-gray-100">
                ...
                <a href="{{ route('admin.notice.index') }}" class="inline-flex justify-center items-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150 ease-in-out">
                    Cancel
                </a>
            </div>
        </form>
